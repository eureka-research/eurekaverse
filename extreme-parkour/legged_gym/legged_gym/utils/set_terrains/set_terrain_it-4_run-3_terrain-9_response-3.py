...
def set_terrain(length, width, field_resolution, difficulty):
    """Complex course with mixed narrow beams, alternating sloped ramps, and platforms for enhanced navigation and balance."""
    ...
    # Obstacle parameters
    beam_width = m_to_idx(0.3 - 0.1 * difficulty)
    ...
    def add_beam(start_x, end_x, mid_y):
        """Add a narrow beam for balance testing."""
    ...
    def add_platform(start_x, end_x, mid_y):
        """Add a platform for resting or jumping onto."""
    ...
    def add_ramp(start_x, end_x, mid_y, direction):
        """Add a ramp for incline/decline traversal."""
        half_width = platform_width // 2
        x1, x2 = start_x, end_x
        y1, y2 = mid_y - half_width, mid_y + half_width
        ramp_height = np.random.uniform(0.3, 0.6) * difficulty
        slant = np.linspace(0, ramp_height, num=y2 - y1)[::direction]  # Create gradient
        height_field[x1:x2, y1:y2] = slant[:, None]  # Broadcast along x-axis
