...
def set_terrain(length, width, field_resolution, difficulty):
    """Balance beams and gaps for the quadruped to navigate carefully."""
    ...
    # Configuration of balance beams
    beam_length = 1.0 + 1.0 * difficulty
    beam_length = m_to_idx(beam_length)
    beam_width = 0.4 + 0.4 * difficulty
    beam_width = m_to_idx(beam_width)
    beam_height_min, beam_height_max = 0.05, 0.30 * difficulty
